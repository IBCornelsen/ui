...
<div>
	<button
		...
		aria-expanded={open}
		class="flex w-full cursor-pointer items-center justify-between gap-3 rounded-xl border border-neutral-400 bg-white px-5 py-4 text-left transition-colors hover:border-primary-300"
	>
	...
	<div class={bodyClass}>
		<div class="overflow-hidden">
			<div class="prose mt-2 rounded-xl border border-neutral-400 bg-white px-5 py-4">
				{@render children()}
			</div>
		</div>
	</div>
