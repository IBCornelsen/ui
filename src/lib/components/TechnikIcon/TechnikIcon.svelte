...
>
	...
	<g transform={spiegeln ? "translate(96 0) scale(-1 1)" : undefined}>
		...
		{:else if name === "elektro-kessel"}
			...
			<path
				d="M50 30 L41 44 L47 44 L44 55 L55 41 L49 41 L53 30 Z"
				fill="var(--elec)"
				stroke="none"
			/>
			{#if stutzen}
		...
		{:else if name === "elektro-dle"}
			...
			<path
				d="M49 18 L42 29 L47 29 L44 38 L53 27 L48 27 L51 18 Z"
				fill="var(--elec)"
				stroke="none"
			/>
			<path
		...
		{:else if name === "bhkw"}
			...
			<path
				d="M34 38 L26 51 L32 51 L29 62 L40 48 L34 48 L38 38 Z"
				fill="var(--elec)"
				stroke="none"
			/>
		...
		{:else if name === "pv-modul"}
			...
			<path
				d="M50 36 L41 50 L47 50 L44 61 L55 47 L49 47 L53 36 Z"
				fill="var(--elec)"
				stroke="none"
			/>
		...
		{:else if name === "batterie"}
			...
			<path
				d="M50 30 L43 41 L48 41 L45 50 L54 39 L49 39 L52 30 Z"
				fill="var(--elec)"
				stroke="none"
			/>
		...
		{:else if name === "pv-dach"}
			...
			{#if mitSonne}
				...
				{@render sonne(16, 16)}
				<path
					d="M60 56 L53 67 L58 67 L55 76 L64 65 L59 65 L62 56 Z"
					fill="var(--elec)"
					stroke="none"
				/>
			{/if}
